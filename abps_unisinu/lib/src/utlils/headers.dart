    ...
    return Container(
      ...
      child: CustomPaint(
        child: SafeArea(child: Padding(
          ...
          child: Text("ABP Matematicas",style: TextStyle(color:Colors.white,fontSize: 25,fontWeight: FontWeight.bold ),textAlign: TextAlign.center, ),
        )),
...
class _HeaderCurvoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Propiedades
    lapiz.color = Color.fromRGBO(229, 41, 62, 1);
    lapiz.style = PaintingStyle.fill; // .fill .stroke
    lapiz.strokeWidth = 20;
...
class _HeaderWavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    lapiz.color = Color.fromRGBO(216, 0, 0,1) ;
    lapiz.style = PaintingStyle.fill; // .fill .stroke
    lapiz.strokeWidth = 20;
